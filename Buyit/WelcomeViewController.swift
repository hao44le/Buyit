...
class WelcomeViewController: UIViewController {
    ...
    @IBOutlet weak var mediumButon: UIButton!
...
//    }
    ...
    @IBAction func easyClicked(sender: UIButton) {
    ...
    @IBAction func hardClicked(sender: UIButton) {
        NSUserDefaults.standardUserDefaults().setInteger(3, forKey: "difficulty")
                self.dismissViewControllerAnimated(true, completion: nil)
        //    }
    }
    ...
    override func viewDidLoad() {
        self.hardButton.layer.cornerRadius = 20
        self.mediumButon.layer.cornerRadius = 20
        self.easyButton.layer.cornerRadius = 20
